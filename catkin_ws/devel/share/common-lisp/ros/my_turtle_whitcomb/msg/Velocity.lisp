...
(cl:in-package my_turtle_whitcomb-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Velocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_turtle_whitcomb-msg:<Velocity> is deprecated: use my_turtle_whitcomb-msg:Velocity instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_turtle_whitcomb-msg:x-val is deprecated.  Use my_turtle_whitcomb-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_turtle_whitcomb-msg:y-val is deprecated.  Use my_turtle_whitcomb-msg:y instead.")
  (y m))
